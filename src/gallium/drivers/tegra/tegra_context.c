...
static int init(struct tegra_stream *stream)
{
   ...
   tegra_stream_push(stream, 0x00000000); /* 0x34f */
   ...
   tegra_stream_push(stream, u_bitcast_f2u(0.0f)); /* TGR3D_VIEWPORT_Z_BIAS */
   ...
   tegra_stream_push(stream, u_bitcast_f2u(0.0f)); /* TGR3D_VIEWPORT_Z_SCALE */
   tegra_stream_push(stream, 0x00000000); /* TGR3D_GUARDBAND_WIDTH */
   tegra_stream_push(stream, 0x00000000); /* TGR3D_GUARDBAND_HEIGHT */
